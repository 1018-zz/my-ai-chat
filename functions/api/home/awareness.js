...
import { getRecentHomeEvents, getHomeMoments, noteTimeLabel } from '../../lib/homeAwareness.js'
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    const homeMoments = await getHomeMoments({ env })
    return json(200, { ok: true, events: out, homeMoments })
  } catch (e) {
